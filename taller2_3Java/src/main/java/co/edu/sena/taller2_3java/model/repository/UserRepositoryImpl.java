...
public class UserRepositoryImpl implements Repository<User> {
    ...
    /*@Override
    public Integer saveObj2(User user) throws SQLException {

        int rowsAffected2=0;

        if (user.getUser_id() != null && user.getUser_id() > 0){
            SELECT *,
                    CAST(AES_DECRYPT(user_password, '$2a$12$0aBzxEI1iH3EGW1tu8JOwe7OvC.ATrCIqD6AM6rroxrfM2hGq9dxS') AS CHAR(50))
